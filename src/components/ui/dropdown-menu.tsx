...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      `z-50 min-w-[8rem] overflow-hidden rounded-md border border-[--light-grey] bg-white p-1 shadow-lg 
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        `z-50 min-w-[8rem] overflow-hidden rounded-md border border-[--light-grey] bg-[--grey] p-1 shadow-md 
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      focus:text-slate-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-[--light-grey] dark:focus:text-slate-50`,
      inset && "pl-8",
      className
    )}
    {...props}
